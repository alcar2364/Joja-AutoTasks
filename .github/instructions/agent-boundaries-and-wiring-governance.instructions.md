...
| UnitTestCliAgent | CLI-focused unit-test creation and test review | No non-test feature implementation ownership |
...
| csharp-style-contract.instructions.md | GameAgent | UIAgent, Refactorer, UnitTestAgent, UnitTestCliAgent, Reviewer, CSharpMentor |
...
| self-splitting-parallel-execution.instructions.md | Orchestrator | GameAgent, UIAgent, StarMLAgent, UnitTestAgent, UnitTestCliAgent, Refactorer, Researcher, Planner, Reviewer, WorkspaceAgent, Troubleshooter, GodAgent |
...
| unit-testing-contract.instructions.md | UnitTestAgent | Reviewer, Planner, UnitTestCliAgent |
...
| csharp-mstest | UnitTestAgent | Reviewer, UnitTestCliAgent |
| csharp-xunit | UnitTestAgent | Reviewer, UnitTestCliAgent |
...
| jat-identifier-determinism-patterns | GameAgent | UnitTestAgent, UnitTestCliAgent, Reviewer |
...
| jat-testing-patterns-and-fixtures | UnitTestAgent | Reviewer, UnitTestCliAgent |
