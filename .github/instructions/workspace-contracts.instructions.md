...
It governs: - how agents interpret requests - how work is planned and delegated - how agents interact with the user - workspace permissions and safety boundaries - file creation and external references

This contract does NOT define: 
- Coding style, see: 
  - [C#](csharp-style-contract.instructions.md)
  - [JSON](json-style-contract.instructions.md)
  - [SML](sml-style-contract.instructions.md)
- Visual design rules, see: [Visual Design Language](visual-design-language.instructions.md)
- UI patterns, see: 
  - [UI Component Patterns](ui-component-patterns.instructions.md)
  - [UI Interaction Patterns](ui-interaction-patterns.instructions.md)
- StarML authoring rules see: [SML Style Contract](sml-style-contract.instructions.md)
- Architecture rules, see: 
  - [Backend Architecture Contract](backend-architecture-contract.instructions.md),
  - [Frontend Architecture Contract](frontend-architecture-contract.instructions.md)
- Code review requirements, see: [Review and Verification Contract](review-and-verification-contract.instructions.md)
- Testing or verification rules, see: [Unit Testing Contract](unit-testing-contract.instructions.md)
...
Agents MAY: - perform research only if the user explicitly asks for it.
...
Instead, the agent SHOULD: - present alternative options - explain tradeoffs - allow the user to choose
