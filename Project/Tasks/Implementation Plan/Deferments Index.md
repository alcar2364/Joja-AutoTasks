...
| DEF-002      | Implement manual task ID issuance and counter ownership in State Store command flow.                                                                | Phase 2       | Phase 2 checklist, Step 4C (manual ID issuance defer)                    | Phase 3          | Active | #101  |                                                            |
| DEF-003      | Implement completion-marking runtime behavior once command/state transition path is in place.                                                       | Phase 2       | Phase 2 checklist guardrails/final gate (completion-marking defer)       | Phase 3          | Active | #102  | Deferred until State Store command flow exists             |
