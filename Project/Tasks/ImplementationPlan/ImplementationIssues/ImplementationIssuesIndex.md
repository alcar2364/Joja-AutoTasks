...
|100|Deferment|Implement localization/translation behavior that changes runtime task content and flow, not just documentation.|Phase 2|Phase 2 checklist, Step 4D (translation-impacting implementation defer)|Phase 4|Open|Low||aligned to Section 21 canonical Phase 4 carryover|
...
|121|Deferment|Implement visual feedback tied to state changes in UI surfaces.|Phase 3|Phase 3 checklist, Deferred Items (Phase 8+ Menu/HUD)|Phase 8/9|Open|Low||May be V2 scope|
